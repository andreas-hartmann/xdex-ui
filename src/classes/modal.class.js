...
class Modal {
    constructor(options, onclose) {
        ...
        let DOMstring = `<div id="modal_${this.id}" class="${this.classes}" style="z-index:${zindex+Object.keys(window.modals).length};" data-augmented-ui="${augs.join(" ")} border inlay exe">`
            <h1>${this.title}</h1>
